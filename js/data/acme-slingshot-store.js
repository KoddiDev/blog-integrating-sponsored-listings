const woodenSlingshot = { title: 'Wooden Slingshot', price: 21.99, rating: 3.2, summary: 'Sling Stuff™ with our basic slingshot!' };
...
const oneYearSlignshotWarranty = { title: 'Acme 1-Year Slingshot Warranty', price: 25.00, rating: 3.7, summary: 'Protect your new slingshot for 1 year.' };
const twoYearSlignshotWarranty = { title: 'Acme 2-Year Slingshot Warranty', price: 35.00, rating: 4.2, summary: 'Protect your new slingshot for 2 years.' };
const threeYearSlignshotWarranty = { title: 'Acme 3-Year Slingshot Warranty', price: 50.00, rating: 4.0, summary: 'Protect your new slingshot investment for 3 years.' };


export const acmeSlingshotProducts = [
    woodenSlingshot,
    plasticSlingshot,
    ironSlingshot,
    steelSlingshot,
    ...
    titaniumSlingshot,
    oneYearSlignshotWarranty,
    adamantiumSlingshot,
    twoYearSlignshotWarranty,
    threeYearSlignshotWarranty,
];
